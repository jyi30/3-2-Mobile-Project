...
public class MainActivity extends AppCompatActivity {
    ...
    //터미널에 keytool -exportcert -alias androiddebugkey -keystore %USERPROFILE%\.android\debug.keystore -storepass android -keypass android | openssl sha1 -binary | openssl base64 등록해야됩니다.
